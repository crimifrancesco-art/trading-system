...
st.markdown("# 🧠 Trading Scanner PRO 27.0")
st.markdown('<div class="section-pill">SERAFINI · FINVIZ · MULTI-WATCHLIST · AGGRID · v27.0</div>',unsafe_allow_html=True)
init_db()
...
if not only_watchlist:
    if st.button("🚀 AVVIA SCANNER PRO 27.0",type="primary",use_container_width=True):
...
(tab_e,tab_p,tab_r,tab_conf,tab_regime,tab_mtf,
 tab_finviz,tab_ser,tab_fvpro,tab_w,tab_hist)=tabs
