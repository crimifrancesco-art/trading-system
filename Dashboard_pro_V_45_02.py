...
# PAGE CONFIG
# =========================================================================
st.set_page_config(page_title="Trading Scanner PRO v45.02",layout="wide",page_icon="🧠")
st.markdown(DARK_CSS,unsafe_allow_html=True)
# ── Back-to-top via st.components (accesso diretto al DOM parent) ────
st.markdown("# 🧠 Trading Scanner PRO v45.02")
...
with tab_home:
    ...
    st.markdown('---')
    # ── V45.022: COT REPORT EVOLUTO ───────────────────────────────────────
    with st.expander("📊 COT Report Evoluto V45.022 — Posizionamento istituzionale", expanded=False):
        if _HAS_COT_EVOLVED:
    ...
    # ── v42i: Suggerimenti ────────────────────────────────
    with st.expander('💡 Suggerimenti v45.02 — Stato e roadmap', expanded=False):
        st.markdown("""
**✅ Implementato in V45.022:**
...
- 📦 Valutare il passaggio da versioni duplicate nella root a tag Git (`v45.02`, `v45.02`).
