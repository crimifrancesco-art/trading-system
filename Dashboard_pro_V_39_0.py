...
# =========================================================================
# v39.3 SAFE MODE: blocco legacy anticipato disattivato per non rompere il layout
# dei tab principali. Le feature legacy restano nel file ma non vengono renderizzate
# prima della definizione reale di st.tabs(...).
if False:
    pass
