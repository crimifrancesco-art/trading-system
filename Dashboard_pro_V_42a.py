...
# PAGE CONFIG
# =========================================================================
st.set_page_config(page_title="Trading Scanner PRO 42.0a",layout="wide",page_icon="🧠")
st.markdown(DARK_CSS,unsafe_allow_html=True)
st.markdown("# 🧠 Trading Scanner PRO 42.0a")
...
with tab_home:
    ...
    with st.expander("🌍 Mappa Calore Globale — Performance indici mondiali v42a", expanded=True):
        try:
    ...
    st.markdown('---')
    with st.expander('📰 NEWS & SENTIMENT v42a — Ultime news con score sentiment · TradingView Italia', expanded=False):
    ...
    # ── v42a: Suggerimenti ────────────────────────────────
    with st.expander('💡 Suggerimenti v42a — Novità e roadmap', expanded=False):
        st.markdown("""
...
- 📈 Confronto portafoglio vs benchmark SPY/QQQ nel tempo
    ...
    st.markdown('<div class="section-pill">🗓️ MACRO CALENDAR v42a — Fed · CPI · NFP · PCE</div>', unsafe_allow_html=True)
...
with tab_w:
    ...
    with st.expander("📈 P&L Tracker & Alert Engine v42a", expanded=False):
        ...
        with st.expander('📡 Canali Notifica v42a', expanded=False):
                ...
                if st.button('📨 Report P&L Telegram',key='pnl_tg_send'):
                    try:
                        ...
                        _rqt.post(f'https://api.telegram.org/bot{_tgtok}/sendMessage',
                            json={'chat_id':_tgcht,'text':'💼 Dashboard v42a P&L','parse_mode':'Markdown'},timeout=8)
                        st.success('✅ Inviato!')
            ...
            with _nc2:
                ...
                if st.button('📧 Report P&L Email',key='pnl_email_send'):
                    try:
                        ...
                        _m=_MT('Dashboard v42a P&L'); _m['Subject']='P&L v41e'; _m['From']=_emfrm; _m['To']=_emto
...
# =========================================================================
with tab_mom:
    st.markdown('<div class="section-pill">⚡ MOMENTUM ALERTS v42a — Ticker · Nome · Tipo · Valore · RSI · Vol× · CSS · Priorità</div>',
                unsafe_allow_html=True)
