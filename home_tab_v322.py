...
# ══ H1: Sparklines height 255 → 190 ══════════════════════════════════════════
n1 = src.count("height=190, paper_bgcolor=BG, plot_bgcolor=PANEL,")
src = src.replace(
...
n2a = src.count("height=120, margin=dict(l=0, r=0, t=20, b=0),")
src = src.replace(
...
# ══ versione ══════════════════════════════════════════════════════════════════
src = src.replace("v32.2", "v32.2")
src = src.replace("home_sparklines_v322", "home_sparklines_v322")
src = src.replace("rsi_dist_v322", "rsi_dist_v322")
src = src.replace("sector_bar_v322", "sector_bar_v322")
src = src.replace("corr_matrix_v322", "corr_matrix_v322")
src = src.replace("home_refresh_v322", "home_refresh_v322")
