...
# PAGE CONFIG
# =========================================================================
st.set_page_config(page_title="Trading Scanner PRO 42.0f",layout="wide",page_icon="🧠")
st.markdown(DARK_CSS,unsafe_allow_html=True)
st.markdown(BACK_TO_TOP_CSS,unsafe_allow_html=True)
st.markdown("# 🧠 Trading Scanner PRO 42.0f")
...
with tab_home:
    ...
    st.markdown("---")
    with st.expander("📅 EARNINGS CALENDAR v42f — Prossimi earnings da Watchlist + Scanner", expanded=False):
        _earn_tickers = set()
    # Da watchlist
    try:
    ...
    st.markdown('---')
    with st.expander('📰 NEWS & SENTIMENT v42f — Ultime news con score sentiment · TradingView Italia', expanded=False):
        _render_news_v41(df_ep)
    st.markdown('---')
    # ── v42f: COT REPORT ─────────────────────────────────────────────────
    with st.expander('📊 COT REPORT v42f — Commitment of Traders (CFTC) · Posizionamento istituzionale', expanded=False):
        st.markdown(
    ...
    # ── v42f: COT REPORT — Commitment of Traders ─────────────────────────
...
""", unsafe_allow_html=True)
    ...
    # ── v42f: Suggerimenti ────────────────────────────────
    with st.expander('💡 Suggerimenti v42f — Novità e roadmap', expanded=False):
        st.markdown("""
**✅ Implementato in v42f:**
- ⬆️ Bottone **Torna su** fisso in basso a destra (smooth scroll, appare dopo scroll)
- 🔢 Versione aggiornata a **42.0f** in tutti i titoli e label
...
- 🌙 Toggle tema persistente per sessione
    ...
    st.markdown('<div class="section-pill">🗓️ MACRO CALENDAR v42f — Fed · CPI · NFP · PCE</div>', unsafe_allow_html=True)
