...
# PAGE CONFIG
# =========================================================================
st.set_page_config(page_title="Trading Scanner PRO 42.0b",layout="wide",page_icon="🧠")
st.markdown(DARK_CSS,unsafe_allow_html=True)
st.markdown("# 🧠 Trading Scanner PRO 42.0b")
...
with tab_home:
    ...
    st.markdown('---')
    with st.expander('📰 NEWS & SENTIMENT v41e — Ultime news con score sentiment · TradingView Italia', expanded=False):
    ...
    # ── v41e: Suggerimenti ────────────────────────────────
    with st.expander('💡 Suggerimenti v42b — Novità e roadmap', expanded=False):
        st.markdown("""
...
- 📱 Layout mobile-first con CSS container queries
    ...
    st.markdown('<div class="section-pill">🗓️ MACRO CALENDAR v41e — Fed · CPI · NFP · PCE</div>', unsafe_allow_html=True)
...
with tab_ai2:
    ...
    st.markdown("<div class='section-pill'>🤖 MODULO 2 AI ANALYST v42b</div>", unsafe_allow_html=True)
...
# =========================================================================
with tab_mom:
    st.markdown('<div class="section-pill">⚡ \1v42b — Ticker · Nome · Tipo · Valore · RSI · Vol× · CSS · Priorità</div>',
                unsafe_allow_html=True)
