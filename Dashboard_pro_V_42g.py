...
# PAGE CONFIG
# =========================================================================
st.set_page_config(page_title="Trading Scanner PRO 42.0g",layout="wide",page_icon="🧠")
st.markdown(DARK_CSS,unsafe_allow_html=True)
st.markdown(BACK_TO_TOP_CSS,unsafe_allow_html=True)
st.markdown("# 🧠 Trading Scanner PRO 42.0g")
...
with tab_home:
    ...
    # ── v42g #4 — EARNINGS CALENDAR (Home) ──────────────────────────────────
    st.markdown("---")
    with st.expander("📅 EARNINGS CALENDAR v42g — Prossimi earnings da Watchlist + Scanner", expanded=False):
        _earn_tickers = set()
        # Da watchlist
        try:
    ...
    st.markdown('---')
    with st.expander('📰 NEWS & SENTIMENT v42g — Ultime news con score sentiment · TradingView Italia', expanded=False):
        _render_news_v41(df_ep)
    st.markdown('---')
    # ── v42g: COT REPORT ─────────────────────────────────────────────────
    with st.expander('📊 COT REPORT v42g — Commitment of Traders (CFTC) · Posizionamento istituzionale', expanded=False):
        st.markdown(
    ...
    # ── v42g: COT REPORT — Commitment of Traders ─────────────────────────
...
""", unsafe_allow_html=True)
    ...
    # ── v42g: Suggerimenti ────────────────────────────────
    with st.expander('💡 Suggerimenti v42g — Novità e roadmap', expanded=False):
        st.markdown("""
**✅ Implementato in v42g:**
...
- 🔢 Versione aggiornata a **42.0g** in tutti i titoli e label
...
- 🌙 Toggle tema persistente per sessione
    ...
    st.markdown('<div class="section-pill">🗓️ MACRO CALENDAR v42g — Fed · CPI · NFP · PCE</div>', unsafe_allow_html=True)
