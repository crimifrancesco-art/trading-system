# -*- coding: utf-8 -*-
# ╔══════════════════════════════════════════════════════════════════════════╗
# ║         TRADING SCANNER PRO  —  v36.0                                  ║
# ║         Upgrade professionale su v35.0 — tutto il codice esistente      ║
# ║         è intatto. Aggiunti 9 upgrade v36 completamente additivi.       ║
# ╠══════════════════════════════════════════════════════════════════════════╣
# ║  CHANGELOG v36  (su base v35 intatta)                                  ║
...
with tab_journal:
    ...
    if _journal:
        ...
        st.download_button("📊 Export Journal XLSX",
            ...
            f"TradingJournal_v36_{_j_ts}.xlsx",
            "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
            key="j_export_xlsx")
    else:
