...
st.markdown('<div class="section-pill">SCANNER V45.07 · OPPORTUNITY RADAR · WATCHLIST ALERT · P&L TRACKER · BACKTEST PRO · EXPORT PRO · CHART TV-STYLE · MTF MATRIX · JOURNAL · REGIME</div>',unsafe_allow_html=True)
init_db()
...
if not only_watchlist:
    if st.button("🚀 AVVIA SCANNER PRO 45.07",type="primary",use_container_width=True):
...
- Usare COT e macro come filtri di contesto, insieme a prezzo, liquidità, volatilità, stop e position sizing.
    ...
    st.markdown("---")
    st.caption("Trading Scanner PRO · Versione V45.07 · Opportunity Radar, Macro Regime e roadmap")
...
# =========================================================================
# ── V45.07: tab Opportunity Radar (strategie selezionabili) ────────────
with tab_radar:
