...
# PAGE CONFIG
# =========================================================================
st.set_page_config(page_title="Trading Scanner PRO 43.0c",layout="wide",page_icon="🧠")
st.markdown(DARK_CSS,unsafe_allow_html=True)
# ── v43c scroll-to-top ──────────────────────────────────────────────────
st.markdown("""
<style>
#v43c-top{position:fixed;bottom:22px;right:18px;z-index:9998;
  background:#1e222d;border:1px solid #363a45;border-radius:50%;
  width:42px;height:42px;display:flex;align-items:center;justify-content:center;
  color:#50c4e0;font-size:20px;text-decoration:none;
  box-shadow:0 2px 12px rgba(0,0,0,0.5);transition:background 0.2s;line-height:1;}
#v43c-top:hover{background:#2962ff;color:#fff;}
</style>
<a id='v43c-top' href='#' title='Torna in cima' aria-label='Torna in cima'>&#9650;</a>
...
st.markdown("# 🧠 Trading Scanner PRO 43.0c")
